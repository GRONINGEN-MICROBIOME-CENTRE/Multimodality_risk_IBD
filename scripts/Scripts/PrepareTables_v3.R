...
DAG3meta=Reduce(function(dtf1, dtf2) merge(dtf1, dtf2, by = "project_pseudo_id", all.x = T),
    ...
    # create IBD_baseline.
DAG3meta$IBD_baselinesafe=ifelse(DAG3meta$IBD_1a == 1 | DAG3meta$IBD_1b == 1 |DAG3meta$IBD_1c == 1 |DAG3meta$IBD_2a == 1, 1, 0)
    # if any missing for controls -> NA
DAG3meta[is.na(DAG3meta)] <- 999
DAG3meta$IBD_baseline1a2a=ifelse(DAG3meta$IBD_1a == 1 | DAG3meta$IBD_1b == 1 |DAG3meta$IBD_1c == 1 |DAG3meta$IBD_2a == 1, 1, ifelse(DAG3meta$IBD_1a == 999 | DAG3meta$IBD_2a == 999, NA, 0))
    # if 1a or 2a missing for controls -> NA
DAG3meta$IBD_baseline1a=ifelse(DAG3meta$IBD_1a == 1 | DAG3meta$IBD_1b == 1 |DAG3meta$IBD_1c == 1 |DAG3meta$IBD_2a == 1, 1, ifelse(DAG3meta$IBD_1a == 999, NA, 0))
    # if 1a missing for controls -> NA
DAG3meta[DAG3meta == 999] <- NA
...
DAG3_full$IBDsafe=ifelse(DAG3_full$IBD_baselinesafe == 1, 1, ifelse(DAG3_full$IBD_followup == 1 & DAG3_full$IBD_baselinesafe != 1 | DAG3_full$IBD_baselinesafe == 999, NA, 0))
DAG3_full$IBD1a2a=ifelse(DAG3_full$IBD_baseline1a2a == 1, 1, ifelse(DAG3_full$IBD_followup == 1 & DAG3_full$IBD_baseline1a2a != 1 | DAG3_full$IBD_baseline1a2a == 999, NA, 0))
DAG3_full$IBD1a=ifelse(DAG3_full$IBD_baseline1a == 1, 1, ifelse(DAG3_full$IBD_followup == 1 & DAG3_full$IBD_baseline1a != 1 | DAG3_full$IBD_baseline1a == 999, NA, 0))
...
DAG3$base_IBDsafeconf=ifelse(DAG3$IBDsafe == 1 & DAG3$base_palga_IBD != "IBD", NA,DAG3$IBDsafe)
DAG3$base_IBD1a2aconf=ifelse(DAG3$IBD1a2a == 1 & DAG3$base_palga_IBD != "IBD", NA,DAG3$IBD1a2a)
DAG3$base_IBD1aconf=ifelse(DAG3$IBD1a == 1 & DAG3$base_palga_IBD != "IBD", NA,DAG3$IBD1a)
...
colnames[c(7:17,25:27,33:34,57)] <- paste0("base_", colnames[c(7:17,25:27,33:34,57)])
colnames[c(28:32,35:56,58:61)]<- paste0("env_", colnames[c(28:32,35:56,58:61)])
...
#write.csv(DAG3meta, "/groups/umcg-lifelines/tmp01/projects/ov23_0813/Amber/metadata/DAG3_metafull_all_v2.csv",row.names=F)

DAG3meta=read.csv("/groups/umcg-lifelines/tmp01/projects/ov23_0813/Amber/metadata/DAG3_metafull_all_v2.csv")
DAG3meta$base_AgeDietEnvironment <- DAG3meta$base_age_1a1
DAG3meta <- select(DAG3meta, -c("env_hometown_childhood_adu_q_1","env_guineapig_childhood_adu_q_1_a", "env_guineapig_childhood_adu_q_1_b","env_guineapig_childhood_adu_q_1_c",
                      "env_bird_childhood_adu_q_1_a","env_bird_childhood_adu_q_1_b","env_bird_childhood_adu_q_1_c","env_cat_childhood_adu_q_1_a","env_cat_childhood_adu_q_1_b","env_cat_childhood_adu_q_1_c",
                      "env_dog_childhood_adu_q_1_a","env_dog_childhood_adu_q_1_b","env_dog_childhood_adu_q_1_c","env_breastfeeding_duration_adu_q_1","env_inhouse_partner_adu_q_1", "env_inhouse_alone_adu_q_1",
                      "env_hormonal_contraception_adu_q_1","env_current_smoker_adu_c_2","env_squashsum_mvpascore_adu_c_1","env_squashsum_reliability_adu_c_2","env_birth_type_adu_q_1", "env_sisters_number_fam_q_1_a",
                      "env_sisters_number_fam_q_1","env_brothers_number_adu_q_1_a","env_brothers_number_adu_q_1","env_birth_type_adu_q_1","env_appendectomy_lifetime_adu_q_1","env_tonsillectomy_lifetime_adu_q_1",
